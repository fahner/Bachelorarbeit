...
\item \CP-Verletzung in der Mischung (auch indirekte \CP-Verletzung): \\
      Die Oszillationen eines \Bd\ in ein \Bdbar und umgekehrt laufen unterschiedlich ab.
\item direkte \CP-Verletzung: \\
      Die Breiten der Zerfälle eines \Bd\ bzw. \Bdbar\ in $\JPsi\Kshort$ sind unterschiedlich: $\Gamma (\text{\Bd} \rightarrow \JPsi\Kshort) \neq \Gamma (\text{\Bdbar} \rightarrow \JPsi\Kshort)$
\item \CP-Verletzung in der Interferenz: \\ !!! hier fehlt noch was !!!
\end{enumerate}
